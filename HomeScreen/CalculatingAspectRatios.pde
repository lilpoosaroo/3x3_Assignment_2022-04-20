void CalculatingAspectRatios() {
  ...
  */
  ...
  if ( widthPic9Larger == true ) imageHeightRatioPic9= float (smallerPic9Dimension) /float (largerPic9Dimension); //=0.5416666667
  if ( heightPic9Larger == true ) imageWidthRatioPic9= float (smallerPic9Dimension) /float (largerPic9Dimension); //=1.846153846
